...
/**
 * LLVM Function Attribute Kind enumeration
 * Represents the different function attributes that can be applied
 * Based on LLVM's Attribute::AttrKind
 * @see https://llvm.org/docs/LangRef.html#function-attributes
 */
export enum AttributeKind {
	AllocAlign = "allocalign",
	AllocatedPointer = "allocptr",
	...
	AllocSize = "allocsize",
	// Additional attributes that may have values

declare namespace llvm {
	...
	type Type =
		...
		| PointerType
		| {
				/* corresponds to class Type in IR/Type.h */
	...
	// biome-ignore lint/suspicious/noShadowRestrictedNames: Under LLVM's API, this is the correct name
